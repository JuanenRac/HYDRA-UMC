...
- **[HYDRA-UMC-SERVER](https://github.com/JuanenRac/HYDRA-UMC-SERVER)** — il backend headless (Node/Express/WebSocket) che prima era integrato nel processo stesso di HYDRA-UMC-STUDIO. Possiede l'API REST/WS di controllo robot, la persistenza di settings.json, l'autenticazione JWT e la discovery mDNS. HYDRA-UMC-STUDIO è ora un client frontend statico puro che comunica con esso tramite rete.
