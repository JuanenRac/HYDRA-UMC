...
* 📐 **Lokale 6-Achsen-Stufe:** Direkte Step/Dir/Enable-Impulserzeugung für 6 lokale Achsen (X, Y, Z, A, B, C), die kartesische Positioniersysteme, Indexierer oder lokale Portale antreiben.
...
- **[HYDRA-UMC-DSI](https://github.com/JuanenRac/HYDRA-UMC-DSI)** — geplant: eine native Touch-UI für den eigenen 7"-DSI-Touchscreen (1280×800) von HYDRA-UMC auf dem Compute Module 5, die denselben Server direkt von der Platine aus steuert. Noch nicht begonnen.
