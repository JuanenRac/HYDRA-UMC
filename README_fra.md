...
### 🤖 La Plateforme Ultime de Micro-Usine à Double Cœur et Contrôleur Multi-Robot (V1.0 - Double Accélérateur IA PCIe Hailo-8 + Hailo-10 et Double Hub USB 3.0)
...
flowchart TB
    ...
    CM5 -- "PCIe Gen 3.0 x1 (jusqu'à 8 Gbps)" --> PCIESW["<b>Switch PCIe Gen3</b><br/>Répartition 1 vers 2 voies"]
    PCIESW -- "PCIe x1" --> HAILO8["<b>Accélérateur IA Hailo-8 M.2</b><br/>26 TOPS - vision haute vitesse"]
    PCIESW -- "PCIe x1" --> HAILO10["<b>Accélérateur IA Hailo-10 M.2</b><br/>40 TOPS - raisonnement cognitif / GenAI local"]
...
* 🧠 **Double Coprocesseur Neuronal Embarqué :** Un switch PCIe Gen3 embarqué répartit l'unique voie PCIe du CM5 entre 2 accélérateurs IA M.2 - un Hailo-8 (26 TOPS) assurant la détection d'objets multi-flux YOLOv8/YOLO11, l'inspection de défauts et l'alignement de repères fiduciaires PnP en temps réel sur les 8 caméras, plus un Hailo-10 (40 TOPS) exécutant du raisonnement cognitif et du GenAI local sur l'appareil lui-même (modèles LLM/VLA quantifiés) sans aller-retour vers le cloud.
...
│   └── HYDRA-UMC_*.md/txt/TXT  # Documents plus anciens - Markdown lorsqu'ils ont été rédigés en Markdown ; voir la bannière de chaque fichier
├── hardware/
│   ├── PCB/
...
Ce projet fait partie d'un écosystème robotique plus vaste du même auteur (JuanenRac / Electro Hobby 3D), composé de nombreux projets couvrant la vision, l'orchestration, les jumeaux numériques et la connectivité industrielle. Cela vaut la peine de le savoir, car une requête pourrait en réalité concerner l'un d'entre eux plutôt que ce repository :

**Directement liés à HYDRA-UMC** — des projets qui se branchent directement sur ce firmware
- **[URTC](https://github.com/JuanenRac/URTC)** — le firmware de la tête d'outil que monte chaque bras robotique piloté par cette carte, un saut de plus via sa propre liaison CAN descendante.
- **[HYDRA-UMC-VISION-NODE](https://github.com/JuanenRac/HYDRA-UMC-VISION-NODE)** — referme la boucle perception/E-STOP avec ce firmware via SPI/CAN.
- **[HYDRA-UMC-SAFETY-ZONES](https://github.com/JuanenRac/HYDRA-UMC-SAFETY-ZONES)** — déclenche l'E-STOP de ce firmware dès qu'une intrusion est détectée.
- **[HYDRA-UMC-VISUAL-SERVOING-API](https://github.com/JuanenRac/HYDRA-UMC-VISUAL-SERVOING-API)** — envoie des corrections cinématiques directement à ce firmware.
- **[HYDRA-UMC-ORCHESTRATOR](https://github.com/JuanenRac/HYDRA-UMC-ORCHESTRATOR)** — coordonne plusieurs unités HYDRA-UMC en essaim.
- **[HYDRA-UMC-TWIN](https://github.com/JuanenRac/HYDRA-UMC-TWIN)** — jumeau numérique qui reproduit la propre cinématique de ce firmware.
- **[URTC-SMART-RACK](https://github.com/JuanenRac/URTC-SMART-RACK)** — partage le même bus CAN d'outils que ce firmware.
- **[URTC-VISION-TOOL](https://github.com/JuanenRac/URTC-VISION-TOOL)** — partage le même bus CAN d'outils que ce firmware.

**Reste de l'écosystème** — regroupé par catégorie
- 💠 **Écosystème Central :** [HYDRA-UMC-SERVER](https://github.com/JuanenRac/HYDRA-UMC-SERVER), [HYDRA-UMC-STUDIO](https://github.com/JuanenRac/HYDRA-UMC-STUDIO), [HYDRA-UMC-SUITE](https://github.com/JuanenRac/HYDRA-UMC-SUITE), [HYDRA-UMC-DSI](https://github.com/JuanenRac/HYDRA-UMC-DSI), [HYDRA-UMC-ANDROID-CONTROL](https://github.com/JuanenRac/HYDRA-UMC-ANDROID-CONTROL), [HYDRA-UMC-IOS-CONTROL](https://github.com/JuanenRac/HYDRA-UMC-IOS-CONTROL), [HYDRA-UMC-EDITOR-URDF](https://github.com/JuanenRac/HYDRA-UMC-EDITOR-URDF), [URTC](https://github.com/JuanenRac/URTC), [URTC-FLASHER](https://github.com/JuanenRac/URTC-FLASHER), [URTC-TESTER](https://github.com/JuanenRac/URTC-TESTER), [URTC-WEB-STUDIO](https://github.com/JuanenRac/URTC-WEB-STUDIO)
- 👁️ **Nœud IA de Vision (Hailo-8) :** [HYDRA-UMC-VISION-STREAMER](https://github.com/JuanenRac/HYDRA-UMC-VISION-STREAMER), [HYDRA-UMC-DETECTION-HEF](https://github.com/JuanenRac/HYDRA-UMC-DETECTION-HEF)
- 🧠 **Nœud IA Cognitif (Hailo-10) :** [HYDRA-UMC-COGNITIVE-NODE](https://github.com/JuanenRac/HYDRA-UMC-COGNITIVE-NODE), [HYDRA-UMC-VLA-ENGINE](https://github.com/JuanenRac/HYDRA-UMC-VLA-ENGINE), [HYDRA-UMC-VOICE-UI](https://github.com/JuanenRac/HYDRA-UMC-VOICE-UI), [HYDRA-UMC-SEMANTIC-PLANNER](https://github.com/JuanenRac/HYDRA-UMC-SEMANTIC-PLANNER), [HYDRA-UMC-DOCS-QA](https://github.com/JuanenRac/HYDRA-UMC-DOCS-QA)
...
- 🎮 **Jumeau Numérique et Simulation :** [HYDRA-UMC-PHYSICS-REPLICA](https://github.com/JuanenRac/HYDRA-UMC-PHYSICS-REPLICA), [HYDRA-UMC-HIL-BRIDGE](https://github.com/JuanenRac/HYDRA-UMC-HIL-BRIDGE), [HYDRA-UMC-SYNTHETIC-DATA-GEN](https://github.com/JuanenRac/HYDRA-UMC-SYNTHETIC-DATA-GEN)
...
- 🛠️ **Outils Complémentaires :** [HYDRA-UMC-WATCH](https://github.com/JuanenRac/HYDRA-UMC-WATCH), [HYDRA-UMC-TOOL-CLI](https://github.com/JuanenRac/HYDRA-UMC-TOOL-CLI), [HYDRA-UMC-DASHBOARD-AI](https://github.com/JuanenRac/HYDRA-UMC-DASHBOARD-AI)
