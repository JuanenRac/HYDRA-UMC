...
| **0.0.0** | Initial versioned release. Real CAN-OTA gateway bootloader (SPI1 to the CM5, FDCAN1 to STACK A, mailbox to CM7 - see this component's own `bootloader_protocol.c`), implementing CRC32 + HMAC-SHA256 verify-into-backup-before-copy-to-main - compiling clean end to end, not yet verified against real hardware. |
