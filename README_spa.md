...
- **[HYDRA-UMC-DSI](https://github.com/JuanenRac/HYDRA-UMC-DSI)** — planificado: una UI táctil nativa para la propia pantalla táctil DSI de 5"/7" (1280×720, misma resolución en ambos tamaños) de HYDRA-UMC en el Compute Module 5, controlando este mismo servidor directamente desde la placa. Todavía no iniciado.
